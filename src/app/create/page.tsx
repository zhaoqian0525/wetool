  ...
  const mobileActions = (
    <>
      ...
      <Link
        ...
        title="教程"
        aria-label="教程"
        className="min-w-[44px] min-h-[44px] flex items-center justify-center text-indigo-600 bg-white border border-indigo-200 rounded-lg hover:bg-indigo-50 active:scale-95 transition-all"
      >
